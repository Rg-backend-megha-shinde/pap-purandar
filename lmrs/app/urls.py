...
urlpatterns = [
    ...
    path('tools/712/api/', views.land_record_712_api, name='land_record_712_api'),
    path('api/land-record-712/ror-locations/', views.land_record_712_ror_locations_api, name='land_record_712_ror_locations_api'),
    path('api/land-record-712/ror-survey-numbers/', views.land_record_712_ror_survey_numbers_api, name='land_record_712_ror_survey_numbers_api'),
    path('api/land-record-712/ror-sync/', views.land_record_712_ror_sync_api, name='land_record_712_ror_sync_api'),
    path('api/land-record-712/ror-save/', views.land_record_712_ror_save_api, name='land_record_712_ror_save_api'),
    path('api/land-record-712/ror-saved-rows/', views.land_record_712_ror_saved_rows_api, name='land_record_712_ror_saved_rows_api'),
    ...
    path('api/analytics/notification/', views.notification_analytics, name='notification_analytics'),
    ...
    path('tools/notification/', views.notification_list, name='notification_list'),
    path('tools/notification/new/', views.notification_new, name='notification_new'),
    path('tools/notification/edit/<int:notification_id>/', views.notification_edit, name='notification_edit'),
    path('tools/notification/download-all/', views.notification_download_csv, name='notification_csv_download'),
    path('tools/notification/download-all-alias/', views.notification_download_csv, name='notification_download_csv'),
    path('api/notification/save/', views.notification_save_api, name='notification_save_api'),
    path('api/notification/draft/<int:notification_id>/', views.notification_draft_data_api, name='notification_draft_data_api'),
    path('api/notification/cascade/<int:notification_id>/', views.notification_cascade_api, name='notification_cascade_api'),
    path('api/notification/list/', views.notification_list_api, name='notification_list_api'),
    path('api/notification/delete/<int:notification_id>/', views.notification_delete_api, name='notification_delete_api'),
    path('api/notification/verify/<int:notification_id>/', views.notification_verify_api, name='notification_verify_api'),
    path('api/notification/delete-selected/', views.notification_delete_selected_api, name='notification_delete_selected_api'),
    path('api/notification/delete-file/<int:file_id>/', views.notification_delete_file_api, name='notification_delete_file_api'),
    path('api/notification/cpi/data/', views.notification_cpi_data_api, name='notification_cpi_data_api'),
    path('api/notification/cpi/list/', views.notification_cpi_list_api, name='notification_cpi_list_api'),
    path('api/notification/cpi/save/', views.notification_cpi_save_api, name='notification_cpi_save_api'),
